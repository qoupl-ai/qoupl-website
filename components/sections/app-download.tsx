        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          >
            ...
            >
              ...
              <span className="text-fluid-sm font-semibold tracking-functional">{data?.badge?.text ?? "Coming Soon"}</span>
            </motion.div>

            <h2 className="text-fluid-5xl font-bold mb-6 leading-tight text-title">
              {title}
            </h2>
            ...
            <div className="space-y-4 mb-8">
              {benefits.map((benefit: string, index: number) => (
                ...
                >
                  ...
                  <span className="text-paragraph text-fluid-base leading-relaxed">{benefit}</span>
                </motion.div>
              ))}
            </div>
            ...
            >
              <Button
                ...
                className="bg-primary hover:bg-primary/90 text-white font-semibold shadow-lg hover:shadow-xl"
              >
            ...
            {ctaSubtext && (
              <p className="mt-4 text-fluid-sm text-secondary-text">
                {ctaSubtext}
              </p>
            )}
          </motion.div>
              ...
              >
                <div className="text-center mb-6">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 mb-4">
                    <Calendar className="h-3.5 w-3.5 text-primary" strokeWidth={1.5} />
                    <span className="text-xs font-semibold tracking-functional text-primary">March 4, 2026</span>
                  </div>
                  <h3 className="font-bold text-fluid-2xl mb-2 leading-snug text-title">Launching Soon on</h3>
                  <p className="text-fluid-sm text-paragraph">
                ...
                <div className="grid grid-cols-4 gap-2 mb-6">
                  <div className="text-center p-3 rounded-lg bg-background/50 border border-border/50">
                    <div className="text-fluid-3xl font-bold text-title mb-1">
                      {timeRemaining.days}
                    </div>
                    <div className="text-xs text-secondary-text tracking-functional">Days</div>
                  </div>
                  <div className="text-center p-3 rounded-lg bg-background/50 border border-border/50">
                    <div className="text-fluid-3xl font-bold text-title mb-1">
                      {timeRemaining.hours}
                    </div>
                    <div className="text-xs text-secondary-text tracking-functional">Hours</div>
                  </div>
                  <div className="text-center p-3 rounded-lg bg-background/50 border border-border/50">
                    <div className="text-fluid-3xl font-bold text-title mb-1">
                      {timeRemaining.minutes}
                    </div>
                    <div className="text-xs text-secondary-text tracking-functional">Minutes</div>
                  </div>
                  <div className="text-center p-3 rounded-lg bg-background/50 border border-border/50">
                    <div className="text-fluid-3xl font-bold text-title mb-1">
                      {timeRemaining.seconds}
                    </div>
                    <div className="text-xs text-secondary-text tracking-functional">Seconds</div>
                  </div>
                </div>
